# Emergency Obstetric and Newborn Care (EMONC) Installation Guide { #rmncah_emonc-installation }

This document includes an installation guide for the Emergency Obstetric and Newborn Care package.
...
- Emergency Obstetric and Newborn Care (dashboard)
...
| Object              | User Groups                             |                                                  |                                                     |
|---------------------|-----------------------------------------|--------------------------------------------------|-----------------------------------------------------|
|                     | EMONC - Access                         | EMONC - Admin                                   | EMONC - Data capture                               |
